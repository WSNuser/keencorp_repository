...
from core.GmailAPI import GMailAPI
...
class KeenCorpUploader:
    ...
    def __init__(self, identity, credentials):
        ...
        default_last_check = "2018-10-01T00:00:00"
    ...
    def process(self):
        ...
        # oa = core.GmailAPI(self.credentials["connector"]["parameters"]["deligation"])
        oa = GMailAPI(self.credentials["connector"]["parameters"]["deligation"])
        # oa = core.Office365API(self.credentials["connector"]["parameters"]["username"], self.credentials["connector"]["parameters"]["password"])
        ...
        for linked_account in self.group_listing:
            ...
            oa.get_messages_linked_mailbox(linked_account, self.last_check_store[linked_account])
            results = oa.getMessages()
            print results[0:3]
            print len(results)
